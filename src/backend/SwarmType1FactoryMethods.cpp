...
SwarmType1LocalIdType SwarmType1FactoryMethods::detectAndOccupyANewLocalSwarmId(CCore& chatCore,
...
SwarmType1* SwarmType1FactoryMethods::createSwarmType1(SwarmType1LocalSwarmNickType localSwarmNick, CCore& chatCore,
        bool& successBool, QString& errorMessage, QString& swarmIdFolderFullPathStr,
    ...
    SwarmType1 * swarm = new SwarmType1(id, localSwarmNick, swarmIdFolderFullPathStr,whiteList);
    return swarm;
}
