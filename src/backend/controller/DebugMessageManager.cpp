...
//cDebugMessageManager::cDebugMessageManager(ConnectionManager* ConnectionManager)
DebugMessageManager::DebugMessageManager(QString Group, QString configPath)
{
...
void DebugMessageManager::doClearAllMessages()
{
	mMessages.clear();
}


void DebugMessageManager::slotNewIncomingDebugMessage(const QString Message){
