...
SoundManager::SoundManager(QString ConfigPath)
...
void SoundManager::slotUserGoOnline()
{
...
void SoundManager::slotFileReciveFinished()
{
	if(mIsMute==true) return;
...
void SoundManager::slotNewChatMessage()
{
	if(mIsMute==true) return;
